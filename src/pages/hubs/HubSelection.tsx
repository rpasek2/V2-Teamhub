...
import { Plus, ArrowRight, Loader2, Ticket, Trophy, Music, Megaphone, Waves, Swords, MoreVertical, EyeOff, Eye, LogOut, Trash2, Building2 } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <button
                    ...
                    className="group relative flex flex-col items-center justify-center overflow-hidden rounded-xl border-2 border-dashed border-slate-300 bg-slate-50 p-6 text-center transition-all hover:border-brand-300 hover:bg-brand-50"
                >
                    <div className="rounded-full bg-white p-3 shadow-sm ring-1 ring-slate-200 group-hover:ring-brand-200">
                        <Ticket className="h-6 w-6 text-slate-400 group-hover:text-brand-600" />
                    </div>
