    ...
    return (
        <div className="h-full flex flex-col">
            <header className="flex items-center justify-between border-b border-slate-700/50 bg-slate-800 px-6 py-4 rounded-t-xl">
                <h1 className="text-2xl font-bold text-chalk-50">Competitions</h1>
                {isStaff && (
                    <button
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        {competitions.map((comp) => (
                            <Link
                                ...
                                className="group relative flex flex-col overflow-hidden rounded-lg border border-slate-700/50 bg-slate-800 shadow-sm transition-all hover:shadow-md hover:border-mint-500/50"
                            >
                                <div className="p-6">
                                    <div className="flex items-center justify-between">
                                        <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-mint-900/30 text-mint-400 group-hover:bg-mint-900/50">
                                    ...
                                    <h3 className="mt-4 text-lg font-semibold text-chalk-50 group-hover:text-mint-400">
                                        {comp.name}
                                    </h3>
                                ...
                                <div className="mt-auto border-t border-slate-700/50 bg-slate-900/50 px-6 py-3">
                                    <span className="text-sm font-medium text-mint-400 group-hover:text-mint-300">
                                        View Details &rarr;
                                    </span>
                                </div>
                            </Link>
