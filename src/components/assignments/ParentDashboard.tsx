    ...
    if (linkedGymnasts.length === 0) {
        return (
            <div className="text-center py-16 card">
                ...
                <h3 className="font-medium text-heading mb-1">No gymnasts linked</h3>
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h2 className="text-xl font-bold text-heading">Today's Training</h2>
                    <p className="text-sm text-muted">
            ...
            {loading ? (
                    ...
                    {[1, 2].map(i => (
                        <div key={i} className="card p-5 animate-pulse">
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-10 h-10 rounded-full bg-surface-active" />
                                <div className="flex-1">
                                    <div className="h-4 bg-surface-active rounded w-24 mb-2" />
                                    <div className="h-3 bg-surface-active rounded w-16" />
                                </div>
                            </div>
                            <div className="h-2 bg-surface-active rounded mb-4" />
                            <div className="flex gap-2">
                                <div className="h-6 bg-surface-active rounded-full w-16" />
                                <div className="h-6 bg-surface-active rounded-full w-16" />
                            </div>
                        </div>
                    ))}
                ...
                <div className="text-center py-12 card">
                    ...
                    <h3 className="font-medium text-heading mb-1">No assignments today</h3>
                    <p className="text-sm text-muted">
            ...
            {gymnastsWithoutAssignments.length > 0 && assignments.length > 0 && (
                <div className="border-t border-line pt-6">
                    <h3 className="text-sm font-medium text-muted mb-3">Rest Day</h3>
                    <div className="flex flex-wrap gap-3">
                        {gymnastsWithoutAssignments.map(gymnast => (
                            ...
                            >
                                <div className="w-6 h-6 rounded-full bg-surface-active flex items-center justify-center text-xs font-medium text-muted">
