    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center gap-2">
                <h3 className="text-lg font-medium text-heading">Internal Notes</h3>
                <span className="text-xs text-faint">(Owner only)</span>
            </div>
                        ...
                        >
                            <div className="flex items-start justify-between gap-3">
                                ...
                                <button
                                    ...
                                    className="p-1.5 text-faint hover:text-red-500 hover:bg-red-500/10 rounded transition-colors flex-shrink-0"
                                >
