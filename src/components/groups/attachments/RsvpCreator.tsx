    ...
    return (
        <div className="rounded-xl border border-blue-500/20 bg-blue-500/10 overflow-hidden">
            <div className="flex items-center gap-2 px-4 py-3 bg-blue-500/15 border-b border-blue-500/20">
                ...
                <h5 className="text-sm font-semibold text-blue-600">Create RSVP Request</h5>
                <button
                    type="button"
                    onClick={onCancel}
            ...
            <div className="p-4 space-y-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        className="block w-full rounded-lg border border-line-strong bg-surface text-heading px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-shadow"
                    />
                </div>
                ...
                {/* Preview */}
                <div className="bg-blue-500/10 rounded-lg p-3 text-sm text-blue-600">
