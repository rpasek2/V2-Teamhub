    ...
    return (
        <Modal isOpen={isOpen} onClose={handleClose} title="Delete Hub">
            <div className="space-y-4">
                ...
                {/* Confirmation input */}
                <div>
                    <label htmlFor="confirmDelete" className="block text-sm font-medium text-body">
                        To confirm, type <span className="font-semibold text-heading">"{expectedText}"</span> below:
                    </label>
                    <input
                        type="text"
                        id="confirmDelete"
                        ...
                        className="mt-2 block w-full rounded-md border border-line-strong px-3 py-2 shadow-sm focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500 sm:text-sm"
