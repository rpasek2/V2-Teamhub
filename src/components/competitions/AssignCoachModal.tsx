...
export function AssignCoachModal({ isOpen, onClose, onCoachesAssigned, sessionId, currentCoachIds }: AssignCoachModalProps) {
    const { hub } = useHub();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Determine which coaches to add and which to remove
