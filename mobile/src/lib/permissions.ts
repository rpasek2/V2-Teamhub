/**
 * Shared permission logic for TeamHub Mobile
 * Mirrors the web app's src/lib/permissions.ts
 */
...
// Type for configured permissions (supports optional values from HubSettings)
export type ConfiguredPermissions = Record<string, Record<string, PermissionScope | undefined> | undefined> | null | undefined;
...
export function getPermissionScope(
    ...
    if (featurePermissions) {
        const scope = featurePermissions[normalizedRole];
